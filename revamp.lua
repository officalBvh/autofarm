...
ML.BackgroundColor3 = Color3.fromRGB(23, 163, 10)
		...
		task.spawn(function()
			if (os.time() >= LastLog) then 
				local s, e = pcall(function()
					SendLog(_G.AutofarmSettings.Webhook, {Player.Name, Player.UserId, WALLET.Text, PROFIT.Text, TIMER.Text, BROKEN.Text, "| HermesWare Farm"})
				end)
				if (e) then 
